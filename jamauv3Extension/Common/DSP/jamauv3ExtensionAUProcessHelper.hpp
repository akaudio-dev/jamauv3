//
//  jamauv3ExtensionAUProcessHelper.hpp
//  jamauv3Extension
//
...
#include <vector>
#include "jamauv3ExtensionDSPKernel.hpp"
#include "jamauv3ExtensionBufferedAudioBus.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(jamauv3ExtensionDSPKernel& kernel, BufferedInputBus& bufferedInputBus)
    : mKernel{kernel},
...
private:
    jamauv3ExtensionDSPKernel& mKernel;
